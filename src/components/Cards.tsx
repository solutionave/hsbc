...
const Cards = () => {
    return (
        <div className='mb-10 px-5 lg:px-96 mt-80'>
            {/* Card */}
            <div className="flex flex-col lg:flex-row justify-center gap-6">
                ...
                <div className="bg-white shadow-md">
                    ...
                    <div className='pt-5 px-10 lg:px-24'>
                        <h1 className="font-thin text-xl lg:text-3xl py-2 lg:py-5 whitespace-nowrap">Annual Report 2024</h1>
                ...
                <div className="bg-white shadow-md">
                    ...
                    />
                    <div className='pt-5 px-10 lg:px-24'>
                        <h1 className="font-thin text-xl lg:text-3xl py-2 lg:py-5 whitespace-nowrap">Fourth Interim Dividend</h1>
                        <div className="mt-2 py-5 text-md lg:text-lg">
